...
class IdentifyCallerTask(AgentTask[Identity | None]):
    ...
    _VERIFY_STEP = (
        ...
        "them letter by letter. Assemble what they said into a normal address — use ONLY the "
        "characters they actually said, never add dots, dashes or numbers "
        "they did not say ('john doe at gmail' is johndoe@gmail.com, not "
        "john.doe@gmail.com) — READ IT BACK, and wait for them to confirm you "
        "heard it right; only then call verify_identity. Never guess at a garbled address. "
